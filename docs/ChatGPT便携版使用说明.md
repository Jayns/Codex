...
### 6. 完成 ChatGPT 与 Windows 首次设置

首次运行 ChatGPT 时，按界面提示选择一个工作类别并继续。若 Windows 请求授予 ChatGPT 一次性权限，请确认发布者为 **OpenAI LLC** 后点击“是”，再点击 **完成设置**。
...
![选择服务商已支持的模型](assets/chatgpt-usage/步骤10-使用.png)
